...
<script>
  $(document).ready(function() {
    ...
    function fetchProducts(search = '', page = 1, perPage = 10) {
      ...
      $.ajax({
        url: `/api/chickensEntries/Entries/search`,
        method: 'GET',
        data: {
          search,
          page,
    ...
    $(document).on('click', '#pagination .page-link', function(e) {
      ...
      dynamicGet({
        url: `/api/chickensEntries/?page=${page}&per_page=${perPage}`,
        renderRow: renderRowTemplate
      });
    });
    ...
    $(document).on('change', '#entriesPerPage', function() {
      ...
      dynamicGet({
        url: `/api/chickensEntries/?page=1&per_page=${perPage}`,
        renderRow: renderRowTemplate
      });
    });
