...
<head>
    ...
    <style>
        ...
        .stat-primary { background: linear-gradient(135deg, var(--primary-color), #6366f1); }
        ...
        .stat-danger { background: linear-gradient(135deg, var(--danger-color), #dc2626); }
        .stat-info { background: linear-gradient(135deg, var(--info-color), #2563eb); }
...
function fetchSummary(params = {}) {
    ...
    $.get(url, function(response) {
        ...
        $('#summary-loader').hide();
        console.error('Failed to load business summary data');
