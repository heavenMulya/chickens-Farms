      ...
      <div class="page-header d-flex justify-content-between align-items-center">
        ...
        <div class="page-btn">
          <a href="#" data-bs-toggle="modal" data-bs-target="#add" class="btn btn-added">
            <i class="fas fa-plus me-2"></i>Add New Chickens Batch
          </a>
        </div>
      </div>
      ...
      <div class="card">
        <div class="card-body">
          ...
          <div id="loader" class="loader-container">
            ...
            <div class="loader-text">Loading Chickens Batchs...</div>
          </div>

          <!-- No Data -->
          <div id="no-data" class="no-data-container" style="display: none;">
            <i class="fas fa-box-open no-data-icon"></i>
            <div class="no-data-title">No Chickens Batch Found</div>
            <div class="no-data-text">There are no Chickens Batch available at the moment. Click "Add New Chickens Batch" to get started.</div>
          </div>
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="addLabel">
            <i class="fas fa-plus-circle me-2" style="color: #ff9f43;"></i>Add New Chickens Batch
          </h5>
          ...
          <div class="row">
            <div class="form-group">
              ...
              <select name="batch_type" id="batch_type" class="form-select" required>
                <option value="" disabled selected>Choose Batch Type</option>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="form-group">
              <label for="batch_type">Batch Type</label>
              <select name="batch_type" id="edit_batch_type" class="form-select" required>
                <option value="" disabled selected>Choose Batch Type</option>
                <option value="broiler">Broiler (Meat)</option>
                <option value="layer">Layer (Eggs)</option>
              </select>
            ...
            <div class="col-12">
              <div class="form-group">
                <label><i class="fas fa-align-left me-2"></i>Chicken Quantity</label>
                <input type="text" class="form-control" id="edit_Quantity" name="quantity" placeholder="Enter Chicken Quantity"></textarea>
              </div>
            </div>
          </div>
        </div>
  ...
  <script>
    $(document).ready(function() {
     ...
     ${details.batch_code}
        ...
        <td>${details.batch_type}</td>
        <td>${details.arrival_date}</td>
        <td>${details.Quantity}</td>
        <td>
          <ul class="list-inline mb-0">
            <li class="list-inline-item">
              <a href="javascript:void(0);" class="px-2 openEditModal" data-id="${details.id}" data-batch_type="${details.batch_type}"  data-Quantity="${details.Quantity}">
