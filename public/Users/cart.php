...
console.log(orderPayload);
    ...
    $.ajax({
        url: 'https://chickens-farms-production-6aa9.up.railway.app/api/orders',
        method: 'POST',
...
function initiatePayment(payload, orderId) {
    $.ajax({
        url: 'https://chickens-farms-production-6aa9.up.railway.app/api/payment/initiate',
        method: 'POST',
...
function markOrderAsPaid(orderId) {
    $.ajax({
        url: `https://your-laravel-domain/api/orders/${orderId}/mark-paid`,
        method: 'PUT',
