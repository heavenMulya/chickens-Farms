         ...
         <div class="row">
             <div class="col-lg-3 col-md-6 mb-4">
                 ...
                 <div class="social-icons">
                     <a href="https://web.facebook.com/rwehumbiza.chickensfarms" target="_blank" class="social-icon">
                         <i class="fab fa-facebook-f"></i>
                     </a>
                     <a href="https://www.tiktok.com/@rwehumbizachicken" target="_blank" class="social-icon">
                         <i class="fab fa-tiktok"></i>
                     </a>
                     <a href="https://www.instagram.com/rwehumbizachickenfarms" target="_blank" class="social-icon">
             ...
             <div class="col-lg-3 col-md-6 mb-4">
                 ...
                 <ul class="footer-links">
                     ...
                     <li><i class="fas fa-envelope"></i> 7:00 AM - 8:00 PM</li>
                     <li><i class="fas fa-clock"></i> Mon-Sunday: 7AM-8PM</li>
                 </ul>
             </div>
         </div>
